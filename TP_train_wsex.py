...
with open('output_tp_wsex.txt', 'w') as f:
    ...
    with open('X_train_wsex.pkl', 'wb') as file:
        pickle.dump(X_train_transformed, file)
    with open('y_train_wsex.pkl', 'wb') as file:
        pickle.dump(y_train, file)    
    print("Normalisation du train set done")
    #chargement du transformer2
    # Enregistrement du transformateur
    with open('transformer2_wsex.pkl', 'wb') as file:
    	pickle.dump(transformer2, file)
    print("transformer enregistré dans transformer2_wsex.pkl")
    X_test_transformed = transformer2.transform(X_test)
    # Sauvegarde des ensembles de test
    with open('X_test_wsex.pkl', 'wb') as file:
    	pickle.dump(X_test_transformed, file)
    with open('y_test_wsex.pkl', 'wb') as file:
    	pickle.dump(y_test, file)
    print("Ensemble de test enregistré dans X_test_wsex.pkl et y_test_wsex.pkl")
    ...
    with open('modele_svm_wsex.pkl', 'wb') as file:
    ...
    # Enregistrez le meilleur modèle dans un fichier
    with open('modele_randomForest_wsex.pkl', 'wb') as file:
    ...
    # Enregistrez le meilleur modèle dans un fichier
    with open('modele_AdaBoostClassifier_wsex.pkl', 'wb') as file:
    ...
    # Enregistrez le meilleur modèle dans un fichier
    with open('modele_GradienBoostingClassifier_wsex.pkl', 'wb') as file:
